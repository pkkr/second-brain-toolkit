...
The Second Brain lives in `~/second-brain/`. It stores durable project
context across sessions, tools, and machines. Keep it useful by loading
and writing only what matters for the current task.
